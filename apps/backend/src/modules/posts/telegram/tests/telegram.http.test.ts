...
describe("POST /api/telegram", () => {
  beforeAll(async () => {
    ...
    const { default: telegramPostIngestionRouter } =
      await import("../telegram.route.js");

    app = express();
    app.use(express.json());
    app.use(API_ROUTES.telegram, telegramPostIngestionRouter);
